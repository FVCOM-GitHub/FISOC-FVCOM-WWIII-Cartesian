...
!  REAL(ESMF_KIND_R8),PARAMETER :: FISOC_secPerYear = 365.2422 * 24.0 * 60.0 * 60.0
  ...
  INTEGER,PARAMETER            :: OM_outputUnit = 37, WM_outputUnit = 32
  INTEGER,PARAMETER            :: CLOCKWISE=1, ANTI_CLOCKWISE=2
  INTEGER,PARAMETER            :: MASK_OPEN_OCEAN=-999.000 ! ESMF regridding leaves this at zero by default
  INTEGER,PARAMETER            :: WM_COLOR = 1, OM_COLOR = 2
